...
public class Main {
    ...
    public static void ConsultaBD1(String[] args)
        ...
        SQLsentence = "INSERT INTO subjects (name, year, hours) VALUES ('MARKUP_LANGUAGE', 1, 5)";
        var result = statement.executeUpdate(SQLsentence);
        System.out.println("Result: " + result);

        SQLsentence = "SELECT * FROM subjects ORDER BY code";
